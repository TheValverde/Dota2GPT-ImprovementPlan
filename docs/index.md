...
**Coach.** Look up a player, pick a match, or paste an account ID and use **Coach latest parsed**. The brief includes lane opponents, towers, Roshan, courier kills, ward times, fights, gold, and who spells actually hit. Unparsed matches can request a parse, then re-analyze.
